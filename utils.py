...
def masked_weighted_binary_crossentropy(y_true, y_pred, weight_zero=1.0, weight_one=1.0):
...
def sampleSet(seqFile, labFile, seqFile2, labFile2, N_CLASS=2):
    ...
    inputY = [labelConverter_2_mask(i[1]) for i in rawData]
    inputY2 = [labelConverter_2_mask(i[1]) for i in rawData2]
